...
/* mainly luke's config, with some modifications to make it work on my device
...
static char selbgcolor[]            = "#585858"; /* 005577 */
...
static const char *termcmd[]  = { TERMINAL, "-e", "/home/alice/.local/bin/term.sh", NULL };
...
static const Key keys[] = {
	...
	/* Brightness control */
	/* { MODKEY, 			XK_j, 	       spawn, 		       {.v = (const char*[]){ "brightnessctl", "set", "2%-", NULL } } }, */
	/* { MODKEY, 			XK_k,  	       spawn, 		       {.v = (const char*[]){ "brightnessctl", "set", "2%+", NULL } } }, */

	{ MODKEY,			XK_a,          togglegaps,             {0} },
	{ MODKEY|ShiftMask,		XK_a,          defaultgaps,            {0} },
	{ MODKEY,			XK_s,          togglesticky,           {0} },
	{ MODKEY|ShiftMask, 		XK_s,	       spawn, 		       {.v = (const char*[]){ "/bin/sh", "-c",
  "mkdir -p \"$HOME/media/pics/screenshot\" && maim -s | tee \"$HOME/media/pics/screenshot/$(date +%F_%H-%M-%S).png\" | xclip -selection clipboard -t image/png",
  NULL } } },
	...
	{ 0, XF86XK_AudioRaiseVolume, spawn, SHCMD("pulsemixer --change-volume +3; pkill -RTMIN+10 dwmblocks") },
	{ 0, XF86XK_AudioLowerVolume, spawn, SHCMD("pulsemixer --change-volume -3; pkill -RTMIN+10 dwmblocks") },
